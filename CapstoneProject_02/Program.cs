...
namespace CapstoneProject_02
{
    ...
    internal class Program
    {
        ...
        public void Borrower()
        {
            ...
            Console.WriteLine("|        3.Display Book Data               |");
        ...
        public static void deleteBook() // function for deleting book
        {
            ...
            {
                Books b = bookList[i] as Books;        // unboxing
                if (b.bookID == deleteBook)
                {
                    bookList.Remove(b);
                    b.bookCount = bookList.Count - 1;
                    Console.WriteLine();
                    Console.WriteLine($" Removed Book of ID = {deleteBook} Sucessfully....");
