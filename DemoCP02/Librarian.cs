...
namespace DemoCP02
{
    ...
    public class Librarian
    {
        ...
        public List<Book> BooksList = new List<Book>();   //creating a list
        //Librarian librarian = new Librarian();
        //librarian.AddBook(BooksList);
        ...
        public void LibrarianMenu()
        {
            ...
            while (menuL != 0)
            {
                ...
                Console.WriteLine("10. Sorted Books List");
        ...
        public void AddBook(List<Book> BooksList)
        {
            ...
            Console.WriteLine("enter total no of books to add :");
            addbook.TotalBooks = int.Parse(Console.ReadLine());

            Console.WriteLine("BookCount :{0}", BookCount);
            this.BooksList.Add(addbook);                         // boxing

            addbook.BookCount = addbook.TotalBooks;
            BookCount = BookCount + addbook.TotalBooks;
        ...
        public void DisplayBooksList()
        {
            ...
            Console.WriteLine("{0,-20} {1,-20} {2,-20} {3,-20} {4, -20} {5,-20} ", "BookID", "Book Title", "Book Category", "Book Price", "Book Status","Total Books added","BookCount");
        ...
        public void SortedBooks()
        {
            ...
            foreach (Book p in this.BooksList)
            {
                Console.WriteLine(p);
            }
        }
